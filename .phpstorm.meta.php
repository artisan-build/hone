...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.connections.hone.driver' => 'string',
            'database.connections.hone.host' => 'string',
            'database.connections.hone.port' => 'integer',
            'database.connections.hone.database' => 'string',
            'database.connections.hone.username' => 'string',
            'database.connections.hone.password' => 'string',
            'database.connections.hone.charset' => 'string',
            'database.connections.hone.prefix' => 'string',
            'database.connections.hone.search_path' => 'string',
            'database.connections.hone.timezone' => 'string',
            ...
            'filesystems.links./Users/edgrosvenor/hone-worktrees/pr9-app-wiring/public/storage' => 'string',
            ...
            'hone-server.apps' => 'array',
            'hone-server.route_prefix' => 'string',
            'hone-server.queue' => 'NULL',
            'hone-server.mcp.path' => 'string',
            'hone-server.mcp.token' => 'NULL',
            'hone-server.mcp.local_name' => 'string',
            'hone-server.database.connection' => 'string',
            'hone-server.database.host' => 'string',
            'hone-server.database.port' => 'integer',
            'hone-server.database.database' => 'string',
            'hone-server.database.username' => 'string',
            'hone-server.database.password' => 'string',
            'hone-server.retention.raw_hours' => 'integer',
            'hone-server.retention.aggregate_days' => 'integer',
            'hone-server.retention.sample_days' => 'integer',
...
'database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.hone.driver','database.connections.hone.host','database.connections.hone.port',
'database.connections.hone.database','database.connections.hone.username','database.connections.hone.password','database.connections.hone.charset','database.connections.hone.prefix',
'database.connections.hone.search_path','database.connections.hone.timezone','database.migrations.table','database.migrations.update_date_on_publish','database.redis.client',
...
'filesystems.links./Users/edgrosvenor/hone-worktrees/pr9-app-wiring/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'session.http_only','session.same_site','session.partitioned','session.serialization','hone-server.apps',
'hone-server.route_prefix','hone-server.queue','hone-server.mcp.path','hone-server.mcp.token','hone-server.mcp.local_name',
'hone-server.database.connection','hone-server.database.host','hone-server.database.port','hone-server.database.database','hone-server.database.username',
'hone-server.database.password','hone-server.retention.raw_hours','hone-server.retention.aggregate_days','hone-server.retention.sample_days','boost.enabled',
...
'hone-server.ingest','hone-server.capabilities','boost.browser-logs','home',
